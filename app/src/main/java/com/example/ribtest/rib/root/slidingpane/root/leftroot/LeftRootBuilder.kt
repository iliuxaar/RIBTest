...
class LeftRootBuilder(dependency: ParentComponent) : ViewBuilder<LeftRootView, LeftRootRouter, LeftRootBuilder.ParentComponent>(dependency) {
   ...
   */
  fun build(parentViewGroup: ViewGroup): LeftRootRouter {
  ...
  override fun inflateView(inflater: LayoutInflater, parentViewGroup: ViewGroup): LeftRootView? {
  ...
  abstract class Module {
    ...
    companion object {
      ...
      internal fun router(
        ...
        return LeftRootRouter(view, interactor, component)
      }
    }
  ...
  interface Component : InteractorBaseComponent<LeftRootInteractor>, BuilderComponent {
