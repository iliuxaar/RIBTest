package com.example.ribtest.extension
...
fun <T> ViewGroup.inflate(layoutId: Int, attachToRoot: Boolean = false): T =
        LayoutInflater.from(context).inflate(layoutId, this, attachToRoot) as T@Suppress("UNCHECKED_CAST")

fun <T> ViewGroup.inflate(layoutId: Int, parentView: ViewGroup, attachToRoot: Boolean = false): T =
        LayoutInflater.from(context).inflate(layoutId, parentView, attachToRoot) as T
